...
const notificacion_schema_1 = require("./schema/notificacion.schema");
...
exports.NotificacionModule = NotificacionModule = __decorate([
    (0, common_1.Module)({
        imports: [mongoose_1.MongooseModule.forFeature([{ name: 'Notificacion', schema: notificacion_schema_1.NotificacionSchema }])],
