...
let GamificacionService = class GamificacionService {
    constructor(userGamificacion) {
        this.userGamificacion = userGamificacion;
    }
    async findAll() {
...
exports.GamificacionService = GamificacionService = __decorate([
    (0, common_1.Injectable)(),
    __param(0, (0, mongoose_1.InjectModel)('Gamificacion')),
